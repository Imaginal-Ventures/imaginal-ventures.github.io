...
const NOTES = [
// TODO: swap with real recent Substack post titles (imaginalventures.substack.com)
...
const VALUES = [
{ ix: "i.", name: "Art & Science", slot: "value-art-science", caption: "Botanical / scientific plate — data meets craft", credit: "Image: Biodiversity Heritage Library · Young, Charlotte M. · 1858", body: "We combine data-driven and neuroscience-informed methods with arts and creativity to enable inventive solutions.\n\nWe lever human responses to both art and science — both as a means to learning and processing, and as tools for creating lasting customer and employee relationships." },
{ ix: "ii.", name: "Candid Curiosity", slot: "value-candid-curiosity", caption: "Vintage art / music graphic — play and inquiry", credit: "Image: Weezer, Pinkerton · 1997", body: "We will always be candid and foster curiosity in our work together. Clear is kind.\n\nCuriosity is the gateway to growth. Founders access growth and uncover blind spots when they have advisors who tell them the truth." },
{ ix: "iii.", name: "Effortful Growth", slot: "value-effortful-growth", caption: "Warm working image — sustained effort", credit: "Image: Radiohead, OK Computer · 1997", body: "We foster effortful growth for optimal performance at the human, team, and organization level.\n\nThe hardest things are worth doing. Founders work on decision-making collaboratively so they can forge relationships for the long term." }];
...
function HomeVariationB() {
  return (
    <div style={{ maxWidth: 1280, margin: "0 auto", fontFamily: F.body, background: C.bone, color: C.ink }}>
      ...
      {/* HERO — split 50/50 */}
      <section style={{ display: "grid", gridTemplateColumns: "1fr 1.1fr", borderBottom: `1px solid ${C.rule}`, minHeight: 720 }}>
        {/* Left: dark panel with cell graphic */}
        <div style={{ background: C.ink, color: C.bone, padding: "72px 56px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          ...
          <div style={{ borderTop: `1px solid #2a2f36`, paddingTop: 18, color: C.mute, fontFamily: F.mono, fontSize: 10, letterSpacing: ".14em", textTransform: "uppercase", display: "flex", justifyContent: "space-between" }}>
        ...
        <div style={{ padding: "72px 64px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <div>
            ...
            <h1 style={{ fontFamily: F.display, fontStyle: "italic", fontWeight: 500, fontSize: 88, lineHeight: 1.02, letterSpacing: "-0.02em", margin: "20px 0 28px", textWrap: "pretty" }}>
      ...
      <div style={{ padding: "0 64px" }}>
        ...
        <section style={{ padding: "48px 0 32px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 0 }}>
            {COPY.proof.map((p, i) =>
            <div key={i} style={{ borderRight: i < 3 ? `1px solid ${C.rule}` : "none", padding: "16px 24px" }}>
                <div style={{ fontFamily: F.display, fontStyle: "italic", fontWeight: 500, fontSize: 64, lineHeight: 1, color: C.cell, letterSpacing: "-0.02em" }}>{p.n}</div>
        ...
        <section id="philosophy" style={{ padding: "48px 0 64px" }}>
          ...
          <div style={{ marginTop: 32, marginBottom: 40, border: `1px solid ${C.rule}`, background: C.bone2 }}>
            ...
            <image-slot
              id="philosophy-plate"
              shape="rect"
              placeholder="Drop a botanical, anatomical, or scientific drawing — warm, hand-drawn, paper-toned"
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, paddingTop: 12, fontFamily: "\"Cormorant Garamond\"" }}>
...
Growth-stage ventures need to activate a blueprint for scale that’s unique to their business. It requires a founder who can see the future clearly and build toward it deliberately. And it requires a shift from a founder-dependent startup to a team with collective capability, designed to create greater value and impact together.`}</p>
          ...
          <div style={{ marginTop: 72, paddingTop: 28, borderTop: `1px solid ${C.ink}` }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 0 }}>
              {VALUES.map((v, i) => <div key={i} style={{ borderTop: `1px solid ${C.rule}`, borderLeft: i === 0 ? "none" : `1px solid ${C.ruleSoft}`, padding: "20px 24px 8px" }}>
                  {/* small found-image box for the value */}
                  <image-slot id={v.slot} shape="rect" fit="cover" position="center" placeholder={v.caption} style={{ display: "block", width: "100%", height: 150, marginBottom: 0, border: `1px solid ${C.rule}`, background: C.bone2 }} />
...
We specialize in intimate, purposeful sessions with tangible outcomes.`}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56 }}>
            {TEAM.map((m, i) => <div key={m.id} style={{ display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ border: `1px solid ${C.rule}`, background: C.bone2, maxWidth: 320 }}>
                  ...
                  shape="rect"
                  fit={m.fit || "contain"}
                  position={m.position || "50% 30%"}
                  placeholder={`Drop a portrait of ${m.name.replace(/[\[\]]/g, "").trim()} — head-and-shoulders, warm light, paper-toned background works best`}
                  style={{ display: "block", height: 380, width: "100%" }} />
        ...
        <section id="problems" style={{ padding: "32px 0 64px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: C.rule, border: `1px solid ${C.rule}` }}>
            {PROBLEMS.map((p, i) =>
            <div key={i} style={{ background: C.bone, padding: "36px 32px", display: "flex", flexDirection: "column", width: "355px" }}>
                ...
                <a href="#offering" style={{ fontFamily: F.mono, fontSize: 10, letterSpacing: ".14em", textTransform: "uppercase", color: C.cell, marginTop: "auto", paddingTop: 24, textDecoration: "none", display: "inline-block", width: "290px" }}>
        ...
        <section id="offering" style={{ padding: "32px 0 64px" }}>
          ...
          <div style={{ marginLeft: -64, marginRight: -64, marginBottom: 36 }}>
            <image-slot
              id="programs-band"
              shape="rect"
              placeholder="Drop a warm, full-bleed image — vintage scientific instrument, music graphic, or art-print plate"
              style={{ display: "block", width: "100%", height: 320 }} />
            
            <div style={{ padding: "12px 64px 0", display: "flex", justifyContent: "space-between", fontFamily: F.mono, fontSize: 10, letterSpacing: ".14em", textTransform: "uppercase", color: C.mute }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 1, background: C.rule, border: `1px solid ${C.rule}`, marginTop: 36 }}>
            {PROGRAMS.map((p, i) =>
        ...
        <section id="trust" style={{ padding: "32px 0 64px" }}>
          ...
          <a
            ...
            <span style={{ fontFamily: F.mono, fontSize: 11, letterSpacing: ".18em", textTransform: "uppercase", background: C.ink, color: C.bone, padding: "18px 28px", display: "inline-block", whiteSpace: "nowrap" }}>TAKE THE TRUST DIAGNOSTIC →
        ...
        <section id="notes" style={{ padding: "32px 0 64px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 32, paddingTop: 36 }}>
            {NOTES.map((n, i) =>
        ...
        <section id="contact" style={{ padding: "32px 0 96px" }}>
          <div style={{ background: C.ink, color: C.bone, padding: "56px 48px", display: "grid", gridTemplateColumns: "1.5fr 1fr", gap: 36, alignItems: "center" }}>
            <div>
              <p style={{ fontFamily: F.mono, fontSize: 11, letterSpacing: ".14em", textTransform: "uppercase", color: C.mute, marginBottom: 12 }}>JOIN US</p>
              <h3 style={{ fontFamily: F.display, fontStyle: "italic", fontWeight: 500, fontSize: 48, margin: 0, lineHeight: 1.05, letterSpacing: "-0.01em" }}>The conversation begins here.
        ...
        <footer style={{ padding: "48px 0 64px", color: C.slate, borderTop: `1px solid ${C.rule}` }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 48, paddingTop: 32 }}>
            <div>
              <Wordmark width={150} />
